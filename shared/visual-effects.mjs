...
export const builtinVisualPresets = [
  ...
  preset({
    ...
    name: "Arco preditivo",
    category: "Superficies",
    note: "Campo de pontos amostrando um arco parametrico, com nucleo luminoso, deriva senoidal e leitura de dados.",
    tags: ["pontos", "arco", "dados", "procedural"],
    performanceTier: 2,
  ...
  preset({
    ...
    note: "Variante em blocos do arco preditivo: grid grosso, nucleo esmeralda e leitura retrô de dados.",
    tags: ["pontos", "pixel", "arco", "dados", "retro"],
    performanceTier: 1,
  ...
  preset({
    ...
    name: "Campo de fitas",
    category: "Fluidos",
    note: "Fitas luminosas com distorcao procedural, grade de pontos e bloom; adaptado do ThreeUI (MIT).",
    tags: ["fitas", "ribbon", "brilho", "grade", "procedural"],
    performanceTier: 2,
