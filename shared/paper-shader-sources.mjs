// Vendored fork derived from Paper Shaders 0.0.76.
// Maintained by Sonara Hub. Apache-2.0; see third_party/paper-shaders.
// Fragment shaders and enums are intentionally local runtime source.

export const colorPanelsFragmentShader = `#version 300 es
...
export const gemSmokeFragmentShader = `#version 300 es
precision mediump float;
...
export const halftoneCmykFragmentShader = `#version 300 es
precision mediump float;
...
export const halftoneDotsFragmentShader = `#version 300 es
precision mediump float;
...
export const paperTextureFragmentShader = `#version 300 es
precision mediump float;
...
export const simplexNoiseFragmentShader = `#version 300 es
precision mediump float;
...
export const staticMeshGradientFragmentShader = `#version 300 es
precision mediump float;
...
export const staticRadialGradientFragmentShader = `#version 300 es
precision mediump float;
...
export { clamp, getShaderColorFromString };
